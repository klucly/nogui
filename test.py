...
class Vector:
    ...
    def __init__(self, matrix: Matrix, coords: Vec2, direction: Union[int, float] = 0, lenght: Union[int, float] = 10, symbol: str = "#") -> None:
        self.coords = coords
        self.matrix = matrix
    ...
    def update(self):
        ...
        ylenght = math.sin(math.radians(self.direction))*self.lenght/1.9
...
while 1:
    ...
    vec.direction += 1
    vec.symbol = f"{vec.direction//360}"[0]
    # matrix.fill()
    vec.update()
    matrix.show()