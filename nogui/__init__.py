...
def press(key):
    return keyboard2.is_pressed(key)
...
class Polygon:
    ...
    def __init__(self, matrix: Matrix, coords: list, symbol: str, fixed_out = False) -> None:
...
class RectangleFULL:
    ...
    def draw(self):
        ...
        coords = self.rotate(coords, self.angle, center)

        self.figure = Polygon(self.matrix, coords, self.symbol, self.fixed_out)
